...
/**
 * Class: This class is the first frame we will interect with when we launching the
 * program
 */
public class FirstFrame {
    ...
    private void initialize() {
        ...
        panel.add(ResButton);
        ResButton.addMouseListener(new MouseAdapter() {
            @Override
